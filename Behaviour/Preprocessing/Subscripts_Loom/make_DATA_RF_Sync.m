...
% 'track_req' refers to whether the experiment took place before or after
% 2020 and so whether the vidoes need to be post-processed to determine the
% position of the mouse again. 

% IF - running through 'process_dome_data.m' 
global inpath exp_name animal_num exp_date track_req exp_name_short

% ELSE - input variables manually
...
% For 'normal' loom stimulus - num_stimrows should == 5.
% This can potentially cause probelms if many rfs have been missed and the
% script thinks the gap is a new stimulus. 
