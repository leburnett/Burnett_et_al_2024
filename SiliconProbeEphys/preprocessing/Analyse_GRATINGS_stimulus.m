...
%                 pref_id_max = find(max_per_stim(i,:) == (max(max_per_stim(i, :))));
        ...
        elseif i2 ==2
            ...
            for cellid = 1:n_gcl
                ...
                d1 = nanmean(vertcat(spikes_per_time1(cellid, :), spikes_per_time(cellid, :)));
                m_d1 = max(d1);
                sp_pt(cellid, :) = d1/m_d1;
                sp_pt_raw(cellid, :) = d1;
                
                d2 = nanmean(vertcat(spikes_per_stim1(cellid,:), spikes_per_stim(cellid,:)));
                m_d2 = max(d2);
